...
const MODULES: NavModule[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { label: 'Purchases (Stock-In)', kind: 'view', view: 'purchases' },
      { label: 'Receivables (Collect Due)', kind: 'view', view: 'receivables' },
      { label: 'Fixed Assets & Depreciation', kind: 'view', view: 'fixed-assets' },
      { label: 'Bank Reconciliation', kind: 'view', view: 'bank-reconciliation' },
      { label: 'Year-End Close', kind: 'view', view: 'year-end' },
